...
from integrations.hubspot import authorize_hubspot, get_hubspot_credentials, get_items_hubspot, oauth2callback_hubspot, clear_hubspot_credentials
...
async def get_hubspot_items(credentials: str = Form(...)):
    ...
    user_id = "TestUser"  # These values match what's in the frontend
    org_id = "TestOrg"
    await clear_hubspot_credentials(user_id, org_id)
    return items
